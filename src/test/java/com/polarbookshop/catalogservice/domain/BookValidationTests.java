...
public class BookValidationTests {
    ...
    void whenIsbnDefineButIncorrectThenValidationFails() {
        var book = new Book(null, "a234567890", "Title", "Author", 9.90, "Polarsophia", null, null, 0);
        Set<ConstraintViolation<Book>> violations = validator.validate(book);
        assertThat(violations).hasSize(1);
        assertThat(violations.iterator().next().getMessage()).isEqualTo("Формат ISBN должен быть действительным.");
    }
